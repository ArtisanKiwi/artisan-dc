...
export default function LifestyleFinalCTA() {
    ...
    <section ref={ref} id="contact" className="section-pad relative overflow-hidden" style={{ background: '#0D1B2A' }}>
      ...
      <div className="container-wide relative z-10">
        <div className="cta-content max-w-3xl mx-auto text-center" style={{ opacity: 0 }}>
          ...
          >
            If your lifestyle brand is ready to acquire customers at scale, validate in market and build the proof that opens retail doors - apply to become an ADC brand partner.
          </p>

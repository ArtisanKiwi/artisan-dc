...
const cards: Card[] = [
  ...
  },
  {
    component: 'quote',
    numberOfStars: 5,
    quote: '"ADC gave us direct access to customers we couldn\'t reach through retail. Within three months we had thousands of new buyers and the velocity data to start conversations with major retailers."',
    companyName: 'Petite Eats',
  ...
  },
  {
    ...
    imageSrc: '/ironclad_partner_logo.png',
    logoBg: '#FFFFFF',
  },
  {
    component: 'photo',
...
export default function LifestyleResults() {

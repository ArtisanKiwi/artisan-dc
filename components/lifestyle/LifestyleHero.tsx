        ...
        <div className="container-wide">
          <div className="flex min-h-[32rem] flex-col items-start justify-center p-8 md:min-h-[44rem] md:p-16">
            <div className="w-full max-w-xl">
              ...
              >
                The Direct Commerce Growth Platform for Lifestyle Brands
              </h1>
              <p
              ...
              <p style={{ color: '#96B0C8', fontSize: 'clamp(0.95rem, 1.4vw, 1.05rem)', lineHeight: '1.75' }}>
                ARTISAN Direct Commerce (ADC) combines live commerce, customer acquisition and commercial intelligence into one integrated platform — helping lifestyle brands generate revenue, build loyal customer communities, own their customer data and create the retail-ready proof needed to scale with confidence.
              </p>
            </div>

...
// NOTE: remaining photo cards and quotes are still placeholders reused
// from the core site. Swap once more beverage-specific assets land.
const cards: Card[] = [
  {
    component: 'photo',
    src: '/beverage/img-1.png',
  ...
  {
    component: 'photo',
    src: '/beverage/img-4-v2.png',
    alt: 'Market event',
  },
]

export default function BeverageResults() {
